...
KINSKI_API gl::FboPtr create_cube_framebuffer(uint32_t the_width, bool with_color_buffer = true,
 ...
 */
KINSKI_API ImagePtr create_image_from_framebuffer(gl::FboPtr the_fbo = gl::FboPtr());
