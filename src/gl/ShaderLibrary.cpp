...
char const* const quad_warp_frag = 
   ...
   "{\n"
   "  // interpolate bottom edge x coordinate\n"
   "  vec2 x1 = mix(u_control_points[2], u_control_points[3], vertex_in.pos.x);\n"
   "  // interpolate top edge x coordinate\n"
   "  vec2 x2 = mix(u_control_points[0], u_control_points[1], vertex_in.pos.x);\n"
   "  \n"
   "  // interpolate y position\n"
   "  vec2 tex_coord = mix(x1, x2, vertex_in.pos.y);\n"
   "  vec4 texColors = vertex_in.color;\n"
