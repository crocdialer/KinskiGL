...
#ifndef _KINSKI_ARRAY_TEXTURE_INCLUDED_
#define _KINSKI_ARRAY_TEXTURE_INCLUDED_
...
namespace kinski{ namespace gl{
    ...
    public:
        ...
        ArrayTexture( int aWidth, int aHeight, int aDepth, Format format = Format() );
        ...
        ArrayTexture(const unsigned char *data, int dataFormat, int aWidth, int aHeight, int aDepth,
        ...
        ArrayTexture(GLenum aTarget, GLuint aTextureID, int aWidth, int aHeight, int aDepth, bool aDoNotDispose);
    ...
    public:
        ...
        typedef ObjPtr ArrayTexture::*unspecified_bool_type;
        operator unspecified_bool_type() const { return ( m_Obj.get() == 0 ) ? 0 : &ArrayTexture::m_Obj; }
